...
serve(async (req) => {
  ...
  try {
    ...
    if (eventType === "order_placed") {
      subject = `Order Confirmation - Mamello's Kitchen #${orderId.slice(0, 8)}`;
      html = generateOrderConfirmationEmail(order, customerName);
      ...
      html = generatePaymentStatusEmail(order, customerName, paymentStatus);
    }
    ...
    const resendResponse = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        from: "Mamello's Kitchen <orders@resend.dev>",
        to: [user.email],
        subject,
        html,
      }),
...
function generateOrderConfirmationEmail(order: any, customerName: string): string {
    ...
    <tr>
      <td style="background-color: #f9fafb; padding: 32px 20px; text-align: center; border-top: 1px solid #e5e7eb;">
        <p style="margin: 0 0 8px 0; color: #666; font-size: 14px;">
          Questions? Contact us at support@mamelloskitchen.com
        </p>
        <p style="margin: 0; color: #999; font-size: 12px;">
          © ${new Date().getFullYear()} Mamello's Kitchen. All rights reserved.
        </p>
      </td>
    </tr>
  </table>
...
function generatePaymentStatusEmail(order: any, customerName: string, status: string): string {
      ...
      <td style="padding: 40px 20px;">
        ...
        <div style="background-color: #f9fafb; padding: 24px; border-radius: 8px;">
          ...
          <p style="margin: 0 0 16px 0; color: #666; font-size: 14px; line-height: 1.5;">
            Please reach out to us at <a href="mailto:support@mamelloskitchen.com" style="color: #d97706; text-decoration: none;">support@mamelloskitchen.com</a> 
        ...
        <div style="margin-top: 32px; padding-top: 24px; border-top: 1px solid #e5e7eb;">
          ...
          <div style="color: #1a1a1a; font-size: 24px; font-weight: 700; color: #d97706;">R${order.total.toFixed(2)}</div>
        </div>
      </td>
    </tr>
